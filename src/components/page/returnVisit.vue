<template>
    <div>
        ...
        学员回访({{number}}人)
                ...
                <div class='studentReturnThree'>
                    <el-date-picker v-model="value3" type="daterange" placeholder="时间段选择" @change="updateList">
                    </el-date-picker>
                </div>
        ...
        <div id="table">
            <el-table :data="returnData" :default-sort="{prop: 'last_time', order: 'descending'}" border>
                ...
                <el-table-column prop="last_time" sortable label="最近回访时间">
                </el-table-column>
                <el-table-column prop="visit_count" label="回访次数">
                </el-table-column>
                <el-table-column class-name='tagClass' prop="tags" label="回访标签" width="130">
                    <template scope="scope">
        ...
        methods: {
            ...
            fetchData() {
                let para = {
                    ...
                    status: this.status,
                    start_time: this.value3 ? typeof(this.value3[0]) != 'object' ? new Date(this.value3[0]).toLocaleString().substring(0, 9) : '' : '',
                    end_time: this.value3 ? typeof(this.value3[1]) != 'object' ? new Date(this.value3[1]).toLocaleString().substring(0, 9) : '' : '',
                    input: this.input2,
                    tag_id: this.value4
                }
