<template>
    ...
    [{{title1}}<i class="el-icon-caret-bottom el-icon--right"></i>]
                ...
                <div class='datec' style='float:left;margin-left:10px'>
                    <el-date-picker v-model="value3" type="daterange" size='small' placeholder="选择日期范围" @change="updateList">
                    </el-date-picker>
                </div>
            </div>
            <div id="table">
                <el-table :data="workData" border show-summary style="width: 100%;height:400px">
    ...
    [{{title4}}<i class="el-icon-caret-bottom el-icon--right"></i>]
            ...
            <div id="table">
                <el-table :data="resourceData" border style="width: 100%;height:400px">
                    <el-table-column prop="date" label="日期">
                    </el-table-column>
                    ...
                    <el-table-column prop="sighrate" label="签到率">
                    </el-table-column>
                </el-table>
                <div class="block">
