    ...
    <div class='courseTableCT'>
        ...
        <el-dialog :title="classTitle" :visible.sync="dialogFormVisibleOverTime" :close-on-click-modal="no" top='10%' size='tiny'>
            ...
            <div class="CTover">
                ...
                <div class="CTover2" v-for='(s,index) in signStatusNo.students' v-if='signStatusNo.students.length!=0'>
                    ...
                    <div :style="s.checkin_types_name=='出勤'?'color:#13ce66':s.checkin_types_name=='请假'?'color:#dba31c':s.checkin_types_name=='旷课'?'color:#ff4949':'color:#c1c2c2'">{{s.checkin_types_name}}</div>
                </div>
        ...
        <el-dialog title="停课" :visible.sync="dialogFormVisibleStop" :close-on-click-modal="no" top='7%' show-close custom-class='stopClass'
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button type="danger" @click="submitTheStop()">提交</el-button>
                <br>
            </div>
        </el-dialog>
        <!-- 申请代课 -->
        <el-dialog title="选择老师" :visible.sync="dialogFormVisibleSubstitute" :close-on-click-modal="no" top='7%' show-close custom-class='substituteClass'
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button type="warning" @click="submitTheTakeOver()">提交</el-button>
                <br>
            </div>
        </el-dialog>
        <el-dialog title="调课" :visible.sync="dialogFormVisibleremedialTitle" :close-on-click-modal="no" top='10%' show-close @close='resetDT'
            ...
            <div slot="footer" class="dialog-footer" style='margin-top:-24px'>
                ...
                <el-button type="info" @click="goToEnd">提交</el-button>
                <br>
            </div>
        </el-dialog>
    </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            //     if (command == 1) {
            //         this.signName.checkin_types_name = '出勤';
            //         this.signName.checkin_types = 1;

            //     } else if (command == 2) {
            //         this.signName.checkin_types_name = '请假';
            //         this.signName.checkin_types = 2;

            //     } else {
            //         this.signName.checkin_types_name = '旷课';
            //         this.signName.checkin_types = 3;
