<template>
        <div class='classLibrary'>
            ...
            <div style='float:left;width:39.5%'>
                ...
                <div id="tableSales">
                    <el-table :data="accountData" border style='width:100%' >
                        ...
                        <el-table-column prop="year_num" label="产品名称">
                        </el-table-column>
                        <el-table-column prop="year_num" label="本月剩余库存(盒)">
                        </el-table-column>
                    </el-table>
                    <!-- <div class="block">
